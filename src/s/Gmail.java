...
public class Gmail extends Authenticator implements Runnable{
	Message msg = null;
	//보내는 서버 주소
            ...
            Session mailSession = Session.getInstance (props,
                   new javax.mail. Authenticator() {
                       protected PasswordAuthentication getPasswordAuthentication () {
                           return new PasswordAuthentication("cafe1944mailsender@gmail.com","cafe1944admin");
                       }
                   });
     ...
     */
     public void send(String to,String subject, String content){
    	 try {
    		 ...
    		 msg.setContent ("CAFE1994 에서 보내는 메일입니다.<br><br>" + content + "<br><br> - CAFE 1944", "text/html;charset=euc-kr" ); //본문내용 보내기
